...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void ManejarCliente(TcpClient cli)
        {
            ...
            //sw.WriteLine("#ESTABLECETURNO#turnoJugador#");
                    ...
                    if (subdatos[1] == "JUGADA")
                    {
                        if (idJug1 == cli.Client.RemoteEndPoint.ToString())
                        {
                            ...
                            if (jugada.checkBaza())
                            {
                                ...
                                sw.WriteLine(puntos.GetNumCartas());
                                sw.WriteLine(puntos.GetNumOros());
                                sw.WriteLine(puntos.GetNumSietes());
                                sw.WriteLine(puntos.GetSieteOros());
                                sw.Flush();
                            }
                            else
                            {
