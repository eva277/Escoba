    ...
    public partial class Cliente : Form
    {
        ...
        private void EnterButton_Click(object sender, EventArgs e)
        {
            if (turno.Equals(idJugador))
            {
                ...
                if (b == null)
                {
                    MessageBox.Show("Debe seleccionar una carta de su mano", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                }
                else
                {
            ...
            try
            {
                ...
                if (dato.Equals("OK"))
                {
                    if (num == 0)
                    {
                        ...
                        CheckCardstimer.Interval=100;
                    }
                }
                else if(dato.Equals("GetPoints"))
                {
